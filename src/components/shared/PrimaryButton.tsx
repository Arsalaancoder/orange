...
export const PrimaryButton: React.FC<PrimaryButtonProps> = ({
  ...
  const baseClasses = cn(
    'inline-flex items-center justify-center bg-[#F26A21] hover:bg-[#D95412] text-white font-semibold rounded-full shadow-sm hover:shadow-lg hover:shadow-[#F26A21]/25 transition-all duration-300 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#F26A21] focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none group cursor-pointer',
    sizeClasses[size],
    fullWidth && 'w-full',
    className
  );
